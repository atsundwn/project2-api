...
Question.create!(topic:'Ruby methods', profile_id:1)
Question.create!(topic:'HTML5', profile_id:1)
Question.create!(topic:'CSS', profile_id:1)
Question.create!(topic:'jQuery', profile_id:1)
Question.create!(topic:'Ruby on Rails', profile_id:1)
Question.create!(topic:'JS objects', profile_id:1)
Question.create!(topic:'SQL CRUD', profile_id:1)
Question.create!(topic:'Rails CRUD', profile_id:1)
Question.create!(topic:'node.js', profile_id:1)
Question.create!(topic:'ember.js', profile_id:1)
Question.create!(topic:'BBQ', profile_id:1)
...
Fist.create!(value:5, profile_id:5, question_id:9)
Fist.create!(value:1, profile_id:1, question_id:9)
